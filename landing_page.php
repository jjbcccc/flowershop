...
if(isset($_POST['add_to_wishlist']) || isset($_POST['add_to_cart'])){
    ...
    // Rest of the code for adding to wishlist or cart
 }
...
function handleAction(productId, actionType) {
  $.ajax({
    url: 'action_handler.php', // PHP file that will handle the AJAX request
    type: 'POST',
    data: {
...
<section class="products">
   ...
   <div class="more-btn">
      <a href="landing_page_shop.php" class="option-btn">load more</a>
   </div>

</section>

<script>
function addToWishlistOrCart(productId, actionType) {
  // Example check; you'll need to set isLoggedIn based on your PHP session in the actual code
  ...
  // If logged in, proceed with form submission or AJAX call for adding to wishlist/cart
  // This part depends on how you want to implement it (submit a form, AJAX request, etc.)
}
</script>
...
<?php @include 'landing_page_footer.php'; ?>
